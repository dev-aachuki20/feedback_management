    ...
    <?php if(count(array_intersect($surveysMenu,$user_permission))>0) { ?> 
        <li class="treeview <?php if(in_array($_GET['page'],array('monthly-report','view-report','view-statistics','report-statistics','view-analytics','survey-outcomes','survey-statistics','view-leagues','view-contacted-list','survey-manage','about','contact-us','view-survey','view-my-assign-task')) and $_GET['type']=='survey') { echo 'active';}?>">
            ...
            <ul class="treeview-menu ">
                <?php if($_SESSION['user_type'] <3) {?>
                    <li class="treeview <?=($_GET['page']=='about' and $_GET['type']=='survey')?'active':''?>">
                        <a class="nav-link" target="_blank" href="./about-us/Survey.pdf?type=survey"><i class="fa fa-light fa-info"></i> <span>ABOUT</span> </a>
                    </li>

                    <li class="treeview <?=($_GET['page']=='contact-us' and $_GET['type']=='survey')?'active':''?>">
                        <a target="_blank" href="https://forms.monday.com/forms/26aca990f8a46879c553077ef9583c8d?r=use1" class="nav-link"> <i class="fa fa-solid fa-at"></i> <span>CONTACT US</span> </a> 
                    </li>
                <?php }?>
                ...
                <li class="treeview <?=make_sidebar_active($_GET['page'],array('view-report','survey-outcomes','view-leagues','view-contacted-list','survey-manage','view-my-assign-task'))?>">
                    ...
                    <ul class="treeview-menu timeline-area child">
                        ...
                        <li class="treeview cusul-line <?=(($_GET['page']=='view-contacted-list' || $_GET['page']=='survey-manage' || $_GET['page']=='view-my-assign-task') and $_GET['type']=='survey') ? 'active':''?>"><a href="?page=view-contacted-list&type=survey" class="nav-link"> <i class=""></i> <span>CONTACTS</span></a> </li>
    ...
    <?php if(count(array_intersect($pulsesMenu,$user_permission))>0) {?> 
        <li class="treeview <?php if(in_array($_GET['page'],array('monthly-report','view-report','view-statistics','report-statistics','view-analytics','survey-outcomes','survey-statistics','view-contacted-list','survey-manage','view-leagues','about','contact-us','view-survey','view-my-assign-task')) and $_GET['type']=='pulse') { echo 'active';}?>">
            ...
            <ul class="treeview-menu">
                <?php if($_SESSION['user_type'] <3) {?>
                    <li class="treeview <?=($_GET['page']=='about' and $_GET['type']=='pulse')?'active':''?>">
                        <a class="nav-link" target="_blank" href="./about-us/Pulses.pdf?type=pulse"><i class="fa fa-light fa-info"></i> <span>ABOUT</span> </a>
                    </li>

                    <li class="treeview  <?=($_GET['page']=='contact-us' and $_GET['type']=='pulse')?'active':''?>">
                        <a target="_blank" href="https://forms.monday.com/forms/db94a0d6621aa675fc652c6f4eaa7fac?r=use1" class="nav-link"> <i class="fa fa-solid fa-at"></i> <span>CONTACT US</span> </a> 
                    </li>
                <?php }?>
                ...
                <li class="treeview <?=make_sidebar_active($_GET['page'],array('view-report','survey-outcomes','view-contacted-list','survey-manage','view-my-assign-task'))?>">
                    <a href="#" class="nav-link "> <i class="fa fa-th-large"></i> <span>RESPONSES</span> <i class="fa fa-angle-left pull-right"></i> </a> 
                    <ul class="treeview-menu timeline-area child">
                        ...
                        <li class="treeview cusul-line <?=(($_GET['page']=='view-contacted-list' || $_GET['page']=='survey-manage' || $_GET['page']=='view-my-assign-task') and $_GET['type']=='pulse') ? 'active':''?>"><a href="?page=view-contacted-list&type=pulse" class="nav-link"> <i class=""></i> <span>CONTACTS</span></a> </li>
    ...
    <?php } ?>
    <!-- Engagement -->
    <li class="treeview <?php if(in_array($_GET['page'],array('monthly-report','view-report','view-statistics','report-statistics','view-analytics','survey-outcomes','survey-statistics','view-contacted-list','survey-manage','view-leagues','about','contact-us','view-survey','view-my-assign-task')) and $_GET['type']=='engagement') { echo 'active';}?>">
        ...
        <?php if($_SESSION['user_type'] <3) { ?>
            <li class="treeview <?=($_GET['page']=='about' and $_GET['type']=='engagement')?'active':''?>">
                <a class="nav-link" target="_blank" href="./about-us/Engagements.pdf?type=engagement"><i class="fa fa-light fa-info"></i> <span>ABOUT</span> </a>
            </li>

            <li class="treeview <?=($_GET['page']=='contact-us' and $_GET['type']=='engagement')?'active':''?>">
                <a target="_blank" href="https://forms.monday.com/forms/244e201a15e6ee459ba87fd7bff15440?r=use1" class="nav-link"> <i class="fa fa-solid fa-at"></i> <span>CONTACT US</span> </a> 
            </li>
            <?php }?>
            ...
            <li class="treeview <?=make_sidebar_active($_GET['page'],array('view-report','survey-outcomes','view-contacted-list','survey-manage','view-my-assign-task','view-my-assign-task'))?>">
                <a href="#" class="nav-link "> <i class="fa fa-th-large"></i> <span>RESPONSES</span> <i class="fa fa-angle-left pull-right"></i> </a> 
                <ul class="treeview-menu timeline-area child">
                    ...
                    <li class="treeview cusul-line  <?=(($_GET['page']=='view-contacted-list' || $_GET['page']=='survey-manage' || $_GET['page']=='view-my-assign-task') and $_GET['type']=='engagement') ? 'active':''?>"><a href="?page=view-contacted-list&type=engagement" class="nav-link"> <i class=""></i> <span>CONTACTS</span></a> </li>
