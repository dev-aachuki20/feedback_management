...
<head>
	...
	<style>
		...
		.google_translate_dropdown .skiptranslate {
        ...
        .goog-te-gadget>div:before,  .goog-te-gadget>div:after{
            content: '';
            position: absolute;
            top: 50%;
        ...
        .goog-te-gadget>div:before{
            ...
            background-image: url(
                   'data:image/svg+xml,<svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(%23clip0_1352_27)"><path d="M48.111 20.6532L27.7165 20.6522C26.8159 20.6522 26.0859 21.3821 26.0859 22.2827V28.7978C26.0859 29.6982 26.8159 30.4283 27.7164 30.4283H39.2014C37.9438 33.6921 35.5965 36.4254 32.6018 38.1621L37.4989 46.6395C45.3546 42.0963 49.9989 34.1247 49.9989 25.201C49.9989 23.9304 49.9053 23.0221 49.718 21.9994C49.5756 21.2223 48.901 20.6532 48.111 20.6532Z" fill="%23167EE6"/><path d="M24.9989 40.2174C19.3784 40.2174 14.4718 37.1465 11.8365 32.6023L3.35938 37.4884C7.67334 44.9652 15.7548 50 24.9989 50C29.5338 50 33.8128 48.7791 37.4989 46.6512V46.6396L32.6018 38.1621C30.3617 39.4613 27.7695 40.2174 24.9989 40.2174Z" fill="%2312B347"/><path d="M37.5 46.6511V46.6395L32.6028 38.162C30.3628 39.4611 27.7708 40.2174 25 40.2174V50C29.5349 50 33.8141 48.779 37.5 46.6511Z" fill="%230F993E"/><path d="M9.78262 25C9.78262 22.2296 10.5387 19.6377 11.8376 17.3977L3.36045 12.5116C1.2209 16.1861 0 20.4535 0 25C0 29.5465 1.2209 33.8138 3.36045 37.4884L11.8376 32.6022C10.5387 30.3623 9.78262 27.7704 9.78262 25Z" fill="%23FFD500"/><path d="M24.9989 9.78262C28.6641 9.78262 32.0307 11.085 34.6603 13.2513C35.309 13.7856 36.2519 13.7471 36.8461 13.1528L41.4623 8.53662C42.1365 7.8624 42.0885 6.75879 41.3683 6.13398C36.9625 2.31182 31.2301 0 24.9989 0C15.7548 0 7.67334 5.03486 3.35938 12.5116L11.8365 17.3978C14.4718 12.8535 19.3784 9.78262 24.9989 9.78262Z" fill="%23FF4B26"/><path d="M34.6613 13.2513C35.3101 13.7856 36.253 13.7471 36.8472 13.1528L41.4634 8.53662C42.1375 7.8624 42.0895 6.75879 41.3693 6.13398C36.9636 2.31172 31.2312 0 25 0V9.78262C28.665 9.78262 32.0317 11.085 34.6613 13.2513Z" fill="%23D93F21"/></g><defs><clipPath id="clip0_1352_27"><rect width="50" height="50" fill="white"/></clipPath></defs></svg>');
            
        }
        .goog-te-gadget>div:after{
            right: 10px;
            background-image: url('data:image/svg+xml,<svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M24.9981 33.3334C24.7239 33.335 24.4521 33.2824 24.1983 33.1787C23.9445 33.0751 23.7136 32.9223 23.5189 32.7292L11.0189 20.2292C10.6266 19.8369 10.4063 19.3049 10.4062 18.7501C10.4062 18.1953 10.6266 17.6632 11.0189 17.2709C11.4112 16.8786 11.9433 16.6582 12.4981 16.6582C13.0529 16.6582 13.585 16.8786 13.9773 17.2709L24.9981 28.3126L36.0189 17.2917C36.4175 16.9504 36.9301 16.7721 37.4545 16.7923C37.9788 16.8126 38.4762 17.0299 38.8472 17.401C39.2182 17.772 39.4356 18.2694 39.4558 18.7937C39.4761 19.318 39.2977 19.8307 38.9564 20.2292L26.4564 32.7292C26.0684 33.1141 25.5447 33.3311 24.9981 33.3334Z" fill="black"/></svg>');
        }
		.google_translate_dropdown .goog-te-combo {
			white-space: nowrap;
		...
		.google_translate_dropdown a img {
			display: none;
		}

		.google_translate_dropdown a span,
		.google_translate_dropdown a {
			color: #555;
		}
  ...
  /*  display: block;*/
		...
		/* .VIpgJd-ZVi9od-xl07Ob-OEVmcd table tr td a div, .VIpgJd-ZVi9od-xl07Ob-OEVmcd table tr td a{
			display: flex !important;
			align-items: center !important;
			color: #0d90b7 !important;
...
<body>
	<section class="signup-step-container">
		<div class="container">
			...
			<div id="google_translate_element" class="google_translate_dropdown"></div>
			<?php
			...
			if ($row_survey_entry > $survey_needed) {
				echo '<div class="alert alert-danger" role="alert"> Survey closed.</div>';
				exit;
			}
			if (isset($_GET['msg'])) { ?>
																					...
																					foreach ($sub_answer as $key => $child_answer_option) { ?>
																						<td colspan="<?php echo count($sub_answer); ?>">
																							<input type="radio" class="form-check-input subque skip-question" name="answerid[<?php echo $questionid; ?>][<?= $row_get_child_questions['id']; ?>]"
																								...
																								data-questionid="<?php echo $questionid; ?>"> <?php echo $child_answer_option; ?>
																						</td>
																					<?php  }
																				}
																			} else {
															...
															<select name="answerid[<?= $question['id']; ?>]" <?= ($question['ifrequired'] == 1) ? 'required' : '' ?> class="form-control subque_select skip-question" data-questionid="<?php echo $question['id']; ?>" data-maxqid="<?= $maxCount ?>" data-question-order="<?php echo $questionOrderNo; ?>">
																...
																?>
																		<option value="<?php echo $row_get_questions_detail['id'] . '--' . $row_get_questions_detail['answer']; ?>"
																			data-skiptoquestion="<?php echo $skipQid; ?>"><?php echo $row_get_questions_detail['description']; ?></option>
																<?php }
																} ?>
															</select>
															<input type="hidden" name="questionid[]" value="<?php echo $questionid; ?>">
	...
	<script type="text/javascript">
        ...
        function filterLanguages() {
            const allowedLanguages = [
                'en', 'pl', 'ro', 'pa', 'ur', 'pt', 'es', 'ar', 'bn', 'gu', 'it', 'ta', 'fr', 
                'lt', 'zh', 'tr', 'bg', 'ru', 'fa', 'hu', 'el'
            ];
        
            const dropdown = document.querySelector('.skiptranslate select');
            if (dropdown) {
                // Add "Select language" option if it doesn't already exist
                let selectLanguageOption = dropdown.querySelector('option[value=""]');
                if (!selectLanguageOption) {
                    selectLanguageOption = document.createElement('option');
                    selectLanguageOption.value = '';
                    selectLanguageOption.textContent = 'Select language';
                    dropdown.insertBefore(selectLanguageOption, dropdown.firstChild);
                }
        
                // Remove unwanted options
                Array.from(dropdown.options).forEach(option => {
                    if (option.value && !allowedLanguages.includes(option.value)) {
                        option.remove();
                    }
                });
            }
    ...
    if (targetNode) {
		...
		// Add class 'test' to all iframe elements
		// document.querySelectorAll('iframe').forEach(function(iframe) {
		// 	iframe.classList.add('test');
		// });

		// // Add class 'demo' to all table elements inside iframes
		// document.querySelectorAll('iframe').forEach(function(iframe) {
		// 	iframe.contentDocument.querySelectorAll('table').forEach(function(table) {
		// 		table.classList.add('demo');
		// 	});
		// });
		// function setLanguageToEnglish() {
        //     // Trigger the dropdown to open
        //     var dropdownTrigger = document.querySelector(".VIpgJd-ZVi9od-xl07Ob-lTBxed");
        //     if (dropdownTrigger) {
        //         dropdownTrigger.click(); // Open the dropdown
                
        //         // Give some time for the dropdown to populate and then click on 'English'
        //         setTimeout(function() {
        //             var englishOption = document.querySelector(".goog-te-menu-frame").contentWindow.document.querySelector("td[lang='en'] a");
        //             if (englishOption) {
        //                 englishOption.click(); // Select English
        //             }
        //         }, 500);
        //     }
        // }
        ...
        // $(document).ready(function() {
        //     setTimeout(setLanguageToEnglish, 1000);
        // });
