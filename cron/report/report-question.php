...
include('./report-question-csv.php');
...
while ($row_get_report = mysqli_fetch_assoc($get_scheduled_report)) {
  ...
  if ($result_1 && $result_2) {
    ...
    if ($row_get_report['send_to'] != null) {
      $attachments = array('document/survey-report-question-' . $row_get_report['id'] . '.pdf', 'document/survey-report-question-' . $row_get_report['id'] . '.csv');
