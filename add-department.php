          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              //only created by and super admin can change status
                if(!empty($_GET['id'])) {
                  if((($_SESSION['user_type']==1 OR $_SESSION['user_type']==2) OR ($row_get_departments_id['cby'] == $_SESSION['user_id'] and $row_get_departments_id['user_type']==$_SESSION['user_type']))){
                    $disabled = "";
                  }else {
                    $disabled = "disabled";
                  }
